...
//    }
    ...
    private static void updateMainPanel(String mode) {
        ...
        switch (mode) {
            case "main" -> {
                ...
                mainPanel.addComponent(new Button("Nauka słówek", OldMain::learningMode));
                mainPanel.addComponent(new Button("Zapisz słownik", OldMain::saveDictionary));
                mainPanel.addComponent(new Button("Wczytaj słownik", OldMain::loadDictionary));
                mainPanel.addComponent(new Button("Wyjście", OldMain::exit));
            }
    ...
    private static void learningMode() {
        ...
        mainPanel.addComponent(new Button("Test", OldMain::startLearningSession));
        mainPanel.addComponent(new Button("Dopasowanie", OldMain::startMatchingLearningSession));
